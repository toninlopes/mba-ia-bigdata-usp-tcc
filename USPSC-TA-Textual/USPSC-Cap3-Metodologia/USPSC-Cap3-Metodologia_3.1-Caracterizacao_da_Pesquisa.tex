...
O \autoref{qua:resumo_pesquisa} sintetiza as escolhas metodológicas adotadas e suas respectivas justificativas.

\begin{quadro}[htb]
	\caption{\label{qua:resumo_pesquisa}Síntese da caracterização metodológica da pesquisa}
