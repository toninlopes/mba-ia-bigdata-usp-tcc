...
\textbf{Etapa 1 — Relevância financeira.} O anotador classifica a publicação em uma de duas categorias mutuamente exclusivas: \textit{tweet financeiro} (valor~1), quando o conteúdo se relaciona
diretamente ao mercado financeiro, à economia, a investimentos ou a eventos com impacto sobre ativos financeiros; ou \textit{não financeiro} (valor~0), quando o conteúdo é de outra natureza — editorial, esportivo, de entretenimento ou sem relação com o contexto econômico-financeiro. Apenas as publicações classificadas como financeiras prosseguem para a segunda etapa.
