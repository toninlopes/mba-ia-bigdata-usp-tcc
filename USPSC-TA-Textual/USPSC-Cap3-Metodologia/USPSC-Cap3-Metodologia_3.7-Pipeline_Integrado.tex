...
\begin{enumerate}
	...
	\item \textbf{Classificação de sentimento}: o corpus pré-processado é submetido a duas abordagens distintas de classificação de sentimento, conforme descrito na 
	\autoref{sec:abordagens}: (a)~abordagem léxica via OpLexicon v3.0, por meio da classe \texttt{OpLexiconAnalyzer}; e (b)~abordagem neural via FinBERT-PT-BR, por meio da classe \texttt{FinBERTAnalyzer}. Ambas gravam os resultados em \texttt{tweets\_classification} com o respectivo campo \texttt{classificator}, permitindo comparação direta com o \textit{gold standard} humano na etapa de avaliação;
