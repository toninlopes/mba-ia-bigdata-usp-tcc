...
A literatura nacional acerca do sentimento do investidor no mercado brasileiro permanece incipiente \cite{galdi2018}, com poucos trabalhos dedicados à construção de modelos de PLN específicos para o domínio financeiro em português. Iniciativas recentes, como o desenvolvimento do FinBERT-PT-BR \cite{santos2023finbert}, representam avanços importantes ao treinar modelos baseados na arquitetura BERT com 1,4 milhão de textos financeiros em português, porém ainda enfrentam limitações quanto ao tamanho das bases de dados rotuladas (apenas 503 textos anotados manualmente).
