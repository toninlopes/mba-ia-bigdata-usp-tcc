...
\begin{enumerate}
	\item Coletar e estruturar um dataset de publicações do X/Twitter dos veículos InfoMoney e Exame, abrangendo o período de outubro de 2025 a fevereiro de 2026;
	...
	\item Desenvolver um pipeline de pré-processamento e análise de sentimento baseado em PLN para classificação da polaridade dos textos coletados;
...
O Capítulo \ref{Cap:Ava_Exp} apresenta os resultados da análise de sentimento realizada, incluindo a caracterização descritiva do dataset, os padrões temporais e semânticos identificados no discurso financeiro dos veículos analisados e a discussão dos achados à luz da literatura.
